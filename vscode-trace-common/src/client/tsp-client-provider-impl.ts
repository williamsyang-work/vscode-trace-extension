...
export class TspClientProvider implements ITspClientProvider {
    ...
    private createNewClients(): void {
        this._tspClient = new TspClient(this._traceServerUrl);
